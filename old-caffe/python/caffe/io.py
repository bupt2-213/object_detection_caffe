...
class Transformer:
    ...
    def preprocess(self, in_, data):
        ...
        - scale raw input (e.g. from [0, 1] to [0, 255] for ImageNet imagenet_models)
        - subtract mean
        - scale feature
    ...
    def set_raw_scale(self, in_, scale):
        ...
        While Python represents images in [0, 1], certain Caffe imagenet_models
        like CaffeNet and AlexNet represent images in [0, 255] so the raw_scale
        of these imagenet_models must be 255.
