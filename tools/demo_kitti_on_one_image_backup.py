...
def demo(net, image_name):
    ...
    save_path = os.path.join('/media/yangshun/0008EB70000B0B9F/PycharmProjects/faster_rcnn/data/demo/result', name)
...
if __name__ == '__main__':
    ...
    prototxt = '/media/yangshun/0008EB70000B0B9F/PycharmProjects/faster_rcnn/models/kitti/VGG16/' \
               'multi_scales_context/test.prototxt'
    caffemodel = '/media/yangshun/0008EB70000B0B9F/roi_roi_new/kitti/multi_scale_context/kittivoc_train/' \
                 'vgg16_faster_rcnn_iter_80000.caffemodel'
    save_root = '/media/yangshun/0008EB70000B0B9F/roi_roi_new/kitti/txt/debug/data'
    ...
    im_names = ['00.jpg', '01.jpg', '02.jpg', '03.jpg', '04.jpg', '05.jpg', '06.jpg', '07.jpg']
    im_names = [os.path.join('../data/demo/web_car', path) for path in im_names]

    # kitti_test_root_dir = '/media/yangshun/0008EB70000B0B9F/Datasets/KITTI/data_object_image_2/KITTI/testing/image_2'
    ...
    for im_name in im_names:
        ...
        demo(net, im_name)
        # generate_evaluate_txt(net, im_name, save_root)
